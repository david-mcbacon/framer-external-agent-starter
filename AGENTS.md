...
- Treat all work as related to this Framer project: https://framer.com/projects/your-project
- Before creating a new Framer session, run `npx @framer/agent@latest session list` and reuse an active session for project `your-project when one exists.
